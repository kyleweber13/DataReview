...
if __name__ == "__main__":
    subjs = ['SBH0360', 'SBH0367', 'SBH0383', 'SBH0429']
    site_code = ''
    visit_num = '01'
    subj = subjs[3]
    ...
    walk_avm_str = print_walking_intensity_summary(df_gait=df_gait, df_epoch=df_epoch, min_dur=30,
                                                   cutpoints=cutpoints[use_author + "Dominant" if hand_dom else use_author + 'Non-dominant'])
    ...
    fig = plot_raw(subj=subj, wrist=wrist, ankle=ankle, ecg=None,
                   ...
                   shade_gait_bouts=True, min_gait_dur=5, mark_steps=True, bout_steps_only=True,
